    ...
    <script type="text/javascript">
        ...
        function openTab(text,url,iconCls){
            if($("#tabs").tabs("exists",text)){
                ...
                var content="<iframe frameborder=0 scrolling='auto' style='width:100%;height:100%' src='/admin/blogger/dispatcher/"+url+"'></iframe>";
                $("#tabs").tabs("add",{
                    title:text,
                    iconCls:iconCls,
                    closable:true,
...
<%--<div region="north" style="height: 60px;background-color: #E0ECFF">
    <table style="padding: 5px" width="100%">
        <tr>
            <td width="50%">
                <img alt="logo" height="60" width="183" src="${pageContext.request.contextPath}/static/images/logo1.png">
            </td>
