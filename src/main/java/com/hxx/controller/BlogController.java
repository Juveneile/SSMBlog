 ...
 * @Description //TODO 博客Controller层
 * @Author haoxx
 * @Date 2019/4/7 - 15:35
 * @Version 1.0
 */
...
public class BlogController {
    ...
    public ModelAndView details(@PathVariable("id") Integer id, HttpServletRequest request)throws Exception{
        ...
        mav.addObject("pageTitle", blog.getTitle()+"博客文章");
        mav.addObject("mainPage", "foreground/blog/contentView.jsp");
        mav.setViewName("mainTemp");
        return mav;
    }
    /**
     *@author haoxx
     *@Description //TODO  获取上一篇博客和下一篇博客
     *@Date 2019/4/7 - 16:12
    ...
    /**
     *@author haoxx
     *@Description //TODO 根据关键字查询相关博客信息
     *@Date 2019/4/7 - 21:21
     *@Param [q]
