            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        <!--通过Controller来跳转页面,并设置伪静态-->
                        <li><a href="${pageContext.request.contextPath}/aboutMe.html"><font color="black"><strong>关于博主</strong></font></a></li>
                        <li><a href="${pageContext.request.contextPath}/download.html"><font color="black"><strong>本站源码下载</strong></font></a></li>
                        <li><a href="${pageContext.request.contextPath}/userLogin.html" target="_blank"><font color="black"><strong>登录</strong></font></a></li>
                    </ul>
